...
const NavBar = () => {
  ...
  let navItems = [
    { href: "/about", icon: ViewIcon, label: "Overview" },
    { href: "/assistants", icon: ActivityIcon, label: "Assistants" },
    { href: "/billing", icon: DollarSignIcon, label: "Support" },
    { href: "/support", icon: HeadsetIcon, label: "Contact" },
  ];
    ...
    <div className="flex flex-col justify-between h-screen">
      <div>
        <header className="text-white px-6 py-4 pb-0 flex items-center bg-[#0e0e0e]">
          <Link href={"/"}>
            <span className="text-2xl font-bold">Auschwitz Guide</span>
          </Link>
        </header>
